	...
	public void run() {
    	try {
            ...
            if(message.charAt(1)!=firstPid.charAt(0)){
                System.out.println("msg: "+message+']');
                Node.sendMsg2(Node.sOut,Node.outCount,message);       	 
            }
                ...
                // System.out.println("coordinator changed to:"+Node.coordinator);
                ...
                if(Node.coordinator!=max){
                   System.out.println(message);
                    System.out.println("max from msg:"+max);
...
public class Node {
	...
	public static void sendMsg(Socket[] sOut,int outCount){
    	try{
    ...
    public static void sendMsg2(Socket[] sOut,int outCount,String message){
    	try{
        	Scanner scan = new Scanner(System.in);
        	int nextNode=0;
        	...
        	System.out.println("new line 142");
        	e.printStackTrace();
    	}
	}
        	...
        	while (option < 5) {
            	...
            	switch (option) {
                	case 1:
                    	...
                    	sIn[inCount] = s.accept();// establishes connection with slaves
